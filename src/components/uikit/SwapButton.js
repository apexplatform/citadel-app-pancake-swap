...
const SwapButton = (props) => {
	...
	return (
        <div className='center'>
            ...
            {swapStatus === 'insufficientBalance' && <BigButtons onClick={() => dispatch(swapActions.getApproveTransaction())} text={`Insufficient ${tokenIn.symbol} balance`} style={customStyle} textColor='#FFFFFF' bgColor='#7C63F5'  hideIcon={true}/>}
